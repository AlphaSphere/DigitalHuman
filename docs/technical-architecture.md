...
- 音视频处理：FFmpeg 命令行。
- 模型服务：Whisper、CozyVoice、HeyGem 先本地调用，后续封装为独立服务。
...
class FFmpegAdapter:
    ...
    def compose_final_video(self, avatar_video_path: str, audio_path: str, subtitle_path: str, output_path: str) -> str:
        pass
```
