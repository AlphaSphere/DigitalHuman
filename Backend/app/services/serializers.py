...
def task_to_dict(task: TaskModel) -> dict:
    ...
    return {
        ...
        "custom_voice_prompt_text": task.custom_voice_prompt_text,
        ...
        "voice_speed": task.voice_speed,
        "background_music_path": task.background_music_path,
        "background_music_mode": task.background_music_mode,
        "background_music_volume": task.background_music_volume,
        "ai_watermark_enabled": task.ai_watermark_enabled,
        "export_without_subtitle": task.export_without_subtitle,
        "avatar_engine": task.avatar_engine,
        "generation_quality": task.generation_quality,
        "tuilionnx_sync_offset": task.tuilionnx_sync_offset,
...
def distribution_to_dict(record: DistributionRecordModel) -> dict:
    ...
    return {
        ...
        "tags": record.tags,
        "cover_artifact_id": record.cover_artifact_id,
