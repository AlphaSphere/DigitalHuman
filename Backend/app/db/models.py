...
class TaskModel(Base, TimestampMixin):
    ...
    pipeline_mode: Mapped[str | None] = mapped_column(String(32))
    pipeline_stage: Mapped[dict | None] = mapped_column(JSON)
    generation_voice_mode: Mapped[str | None] = mapped_column(String(32))
    custom_voice_path: Mapped[str | None] = mapped_column(String(512))
    custom_voice_prompt_text: Mapped[str | None] = mapped_column(Text)
    generation_video_mode: Mapped[str | None] = mapped_column(String(32))
    custom_video_path: Mapped[str | None] = mapped_column(String(512))
    avatar_engine: Mapped[str | None] = mapped_column(String(32))
    generation_quality: Mapped[str | None] = mapped_column(String(32), default="full")
    tuilionnx_sync_offset: Mapped[int | None] = mapped_column(Integer, default=0)
    ...
    background_music_mode: Mapped[str | None] = mapped_column(String(32))
    background_music_volume: Mapped[float | None] = mapped_column(Float)
    ai_watermark_enabled: Mapped[bool | None] = mapped_column(Boolean)
    export_without_subtitle: Mapped[bool | None] = mapped_column(Boolean)
...
class DistributionRecordModel(Base, TimestampMixin):
    ...
    cover_artifact_id: Mapped[str | None] = mapped_column(String(64))
